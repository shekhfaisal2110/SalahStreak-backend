  ...
  import { protect } from '../middleware/auth.js';
import { getCurrentProgress, startNewProgress, markPara, togglePara, getCompletions, getCompletionsByDateRange } from '../controllers/quranController.js';
  ...
  windowMs: 60 * 1000,
  max: 120,   // allow up to 2 clicks per second – plenty for 30 paras
  message: { success: false, message: 'Too many para updates, please slow down' },
});
  ...
  router.put('/para/:para/toggle', paraLimiter, togglePara);
